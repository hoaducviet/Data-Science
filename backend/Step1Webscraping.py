...
def webScraping():
    ...
    game_info.to_csv("./Data/game_info.csv", index = False, header = True, mode='w')
    game_info.to_excel("./Data/game_info.xlsx", index = False, header = True, engine='xlsxwriter')

#Chạy file step1 bằng cách gọi hàm: webScraping()
